...
@app.callback(
    ...
    Input(component_id={'type': 'b_remove_mvar', 'index': ALL}, component_property='n_clicks')],
        ...
        new_mvar = html.Div(
            ...
            children=[
                ...
                dcc.Dropdown(id={
                    ...
                    style={'width':'10%','display':'inline-block', 'min-width':'100px'},
                    value=None,
                    clearable=False),
                dcc.Input(id={
                    'type': 'm_start',
...
@app.callback(
    ...
    State(component_id={'type': 'm_start', 'index': ALL}, component_property='value'),
    State(component_id={'type': 'm_stop', 'index': ALL}, component_property='value'),
